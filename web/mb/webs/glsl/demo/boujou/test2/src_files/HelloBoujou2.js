...
// 全画幅相机传感器尺寸为35mmx24mm
// const boujouCameraCMOSHeight = 35;
const boujouCameraCMOSHeight = 18;
...
function initScene() {
    ...
    // renderer.setCullFace(THREE.CullFaceNone);
...
function initBoujouScene() {
    ...
    /*boujouCameraMatrix = new Float32Array([
        curCameraPos[0], curCameraPos[1], curCameraPos[2], 0,
        curCameraPos[3], curCameraPos[4], curCameraPos[5], 0,
        curCameraPos[6], curCameraPos[7], curCameraPos[8], 0,
        -curCameraPos[9] * worldScaleFactor, curCameraPos[10] * worldScaleFactor, curCameraPos[11] * worldScaleFactor, 1]);*/
...
function drawBoujouScene() {
    ...
    // boujouCameraMatrix = m4.xRotate(boujouCameraMatrix, rotatex);
    // orginalBoujouCameraMatrix
    // boujouCameraMatrix = m4.yRotate(orginalBoujouCameraMatrix, freeCameraRotationY);
...
function loadOBJ() {
    ...
    // loader.load('assets/banana.obj', addBananaInScene);
    // loader.load('src_files/models/3/banana.obj', addBananaInScene);
    // loader.load('src_files/models/3/banana2.obj', addBananaInScene);
    // loader.load('src_files/models/2/sxj.obj', addBananaInScene);// code/assets/banana.obj
    // loader.load('src_files/models/2/sxj1.obj', addBananaInScene);// code/assets/banana.obj
    // loader.load('src_files/models/2/sxj1_no_mtl.1.obj', addBananaInScene);// code/assets/banana.obj

    // loader.load('src_files/models/6/camera2_model.obj', addBananaInScene);// code/assets/banana.obj
    // loader.load('src_files/models/6/camera3_model.obj', addBananaInScene);// code/assets/banana.obj
    // loader.load('src_files/models/6/camera_model3.4.obj', addBananaInScene);// code/assets/banana.obj
    // loader.load('src_files/models/6/camera4_model_flip_yz.obj', addBananaInScene);
    // loader.load('src_files/models/6/camera4_model_noflip_yz.obj', addBananaInScene);
    // loader.load('src_files/models/6/camera002.1.obj', addBananaInScene);
...
function addBananaInScene (object) {
    ...
    // banana.rotation.z = Math.PI;
    // banana.position.y = -200;
    // banana.position.z = 50;

    // banana.position.x = 0;
    // banana.position.y = 200;
    // banana.position.z = 500;

    // boujouCameraOriginPosition = [boujouFramesData[0][9] * worldScaleFactor, boujouFramesData[0][10]* worldScaleFactor, boujouFramesData[0][11]* worldScaleFactor];
...
function initPlane() {
    ...
    planeMatrixLocation = gl1.getUniformLocation(planeProgram1, "u_matrix");
...
function render () {
    ...
    if(animationBegin)
    {
        ...
        if(animationFrameCount % 3 == 0)
        {
            ...
            /*curBoujouCameraRotateMatrix = new Float32Array(Number(curCameraPos[0]), Number(curCameraPos[1]), Number(curCameraPos[2]), 0,
                Number(curCameraPos[3]), Number(curCameraPos[4]), Number(curCameraPos[5]), 0,
                Number(curCameraPos[6]), Number(curCameraPos[7]), Number(curCameraPos[8]), 0,
                0,              0,                0,              1);*/
            ...
            /*boujouCameraMatrix = new Float32Array([
                ...
                curCameraPos[3], curCameraPos[4], curCameraPos[5], 0,
                curCameraPos[6], curCameraPos[7], curCameraPos[8], 0,
                -curCameraPos[9], curCameraPos[10], curCameraPos[11], 1]);*/

           /* curBoujouCameraRotateMatrix.set(
                curCameraPos[0], curCameraPos[1], curCameraPos[2], 0,
                curCameraPos[3], curCameraPos[4], curCameraPos[5], 0,
                curCameraPos[6], curCameraPos[7], curCameraPos[8], 0,
                0,              0,                0,              1
            ...
            // rotateMatrix.set(curBoujouCameraRotateMatrix);
            rotateMatrix.set(
                Number(curCameraPos[0]), Number(curCameraPos[1]), Number(curCameraPos[2]), 0,
                Number(curCameraPos[3]), Number(curCameraPos[4]), Number(curCameraPos[5]), 0,
                Number(curCameraPos[6]), Number(curCameraPos[7]), Number(curCameraPos[8]), 0,
    ...
    // freeCameraProjectionMatrix = camera.projectionMatrix;

    // Compute the camera's matrix using look at.
    // var orbitRadius = 1600;
    // freeCameraOrbitTime = time * 0.05;
    ...
    // freeCameraRotationX = camera.rotation.x;
    // freeCameraRotationY = camera.rotation.y;
    ...
    // var curTarget = [0, 0, 0];
    // var up = [0, 1, 0];
    /*var curTarget = new THREE.Vector3(0, 0, 0);
    curTarget = camera.getWorldDirection(curTarget);
    freeCameraTarget = [curTarget.x, curTarget.y, curTarget.z];*/
...
function renderPlane() {
    ...
    planeViewMatrix = m4.translate(freeCameraViewProjectionMatrix, planeTranslationArr[0], planeTranslationArr[1], planeTranslationArr[2]);
    // planeViewMatrix = m4.translate(camera.projectionMatrix, planeTranslationArr[0], planeTranslationArr[1], planeTranslationArr[2]);


    // gl1.uniformMatrix4fv(planeMatrixLocation, false, viewProjectionMatrix);
    gl1.uniformMatrix4fv(planeMatrixLocation, false, planeViewMatrix);
    // draw
