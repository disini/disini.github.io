...
var container, stats, permalink, hex, color, canvas1;
...
function init() {
    ...
    canvas1 = document.getElementById("canvas1");
    canvas1.appendChild(container);*/
    // document.querySelector('#canvas1').appendChild(container);
    ...
    // scene.background = new THREE.Color(0x20000001);// RGBA

    // scene.fog = new THREE.Fog(0x000000, 250, 1400);
    // scene.fog = new THREE.Fog(0x00000002, 250, 1400);
